...
const ContactInfo = () => (
    <div className="flex-1 px-8 py-14">
        <h2 className="text-4xl font-bold text-custom-3 mb-4">Get in Touch</h2>
        ...
        {contactInfo.map((contact) => (
            ...
            >
                <span className="text-xl rounded-full bg-custom-2/40 h-14 p-4 w-14 lg:w-20 lg:h-20 flex items-center justify-center border border-custom-2">
                    <contact.icon />
                </span>
